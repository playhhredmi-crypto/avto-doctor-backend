...
ALTER TABLE ustalar ADD COLUMN IF NOT EXISTS karta_raqami VARCHAR(30);
ALTER TABLE ustalar ADD COLUMN IF NOT EXISTS ish_radiusi_km INTEGER DEFAULT 15;
ALTER TABLE orders ADD COLUMN IF NOT EXISTS rasm TEXT;
ALTER TABLE orders ADD COLUMN IF NOT EXISTS bekor_jarima NUMERIC DEFAULT 0;
